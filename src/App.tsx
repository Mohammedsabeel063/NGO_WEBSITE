  ...
  return (
    <div className="w-full min-h-screen bg-white text-gray-900 font-sans text-lg">
      ...
      <section id="about" className="py-24 bg-white w-full">
        <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 py-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 mb-6">About Basti Ki Pathshala</h2>
      ...
      <section id="volunteer" className="py-24 bg-gray-50 w-full">
        <div className="max-w-3xl xl:max-w-4xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 mb-6">Join Our Mission</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-400">
                ...
                <li><button onClick={() => scrollToSection('volunteer')} className="hover:text-white transition-colors">Volunteer</button></li>
              </ul>
            </div>
            <div>
